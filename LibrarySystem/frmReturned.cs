...
namespace LibrarySystem
{
    public partial class frmReturned : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            printer.Footer = "MateLibrary";
            printer.FooterSpacing = 15;
            printer.printDocument.DefaultPageSettings.Landscape = true;
            printer.PrintDataGridView(dtgListreturned);
        }

        private void button3_Click(object sender, EventArgs e)
        {
            DGVPrinter printer = new DGVPrinter();
            printer.Title = "Unreturned Report";
            printer.SubTitle = string.Format("Date: {0}", DateTime.Now.Date.ToString("MM/dd/yyyy"));
            printer.SubTitleFormatFlags = StringFormatFlags.LineLimit | StringFormatFlags.NoClip;
            printer.PageNumbers = true;
            printer.PageNumberInHeader = false;
            ...
            printer.FooterSpacing = 15;
            printer.printDocument.DefaultPageSettings.Landscape = true;
            printer.PrintDataGridView(dtg_RlistReturn);
        }

        private void dtg_RlistReturn_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
